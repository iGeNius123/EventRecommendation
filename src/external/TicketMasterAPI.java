...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "asbyjEGA2buirqT32vGhpdDKrT3sRPMG";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		// make url query like: "apikey=12345&geoPoint=abcd&keyword=music&radius=50"
		...
		try {
			...
			//send request to TicketMaster and get response, response conde could be returned directly
